...
Description: 3D抓图脚本，接收任务编号和储位名称作为参数
...
def main(task_no: str, bin_location: str):
    ...
    try:
        ...
        # 登录
        print("尝试登录相机...")
        result = cam.login("10.16.82.180", 8000, "admin", "qwe147852")
        print(f"登录结果: {result}")
...
if __name__ == "__main__":
    # 创建参数解析器
    parser = argparse.ArgumentParser(description='3D抓图脚本')
